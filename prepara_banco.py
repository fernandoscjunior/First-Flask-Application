import MySQLdb
print('Conectando...')
conn = MySQLdb.connect(user='root', passwd='Fer141200@', host='localhost', port=3306)
...
criar_tabelas = '''SET NAMES latin1;
    ...
    CREATE TABLE `jogo` (
      ...
      `categoria` varchar(40) COLLATE utf8_general_ci NOT NULL,
      `console` varchar(20) NOT NULL,
      PRIMARY KEY (`id`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
    CREATE TABLE `usuario` (
      `id` varchar(8) COLLATE utf8_general_ci NOT NULL,
      `nome` varchar(20) COLLATE utf8_general_ci NOT NULL,
      `senha` varchar(8) COLLATE utf8_general_ci NOT NULL,
      PRIMARY KEY (`id`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;'''
